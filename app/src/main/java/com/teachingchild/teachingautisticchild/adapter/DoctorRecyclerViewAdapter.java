...
public class DoctorRecyclerViewAdapter extends RecyclerView.Adapter<DoctorRecyclerViewAdapter.ViewHolder> {
    ...
    //vars
    private List<DoctorAdvice> itemsList = new ArrayList<>();

    private Context mContext;

    public DoctorRecyclerViewAdapter(Context context, List<DoctorAdvice> items) {
        itemsList = items;
        mContext = context;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_doctorlist, parent, false);
