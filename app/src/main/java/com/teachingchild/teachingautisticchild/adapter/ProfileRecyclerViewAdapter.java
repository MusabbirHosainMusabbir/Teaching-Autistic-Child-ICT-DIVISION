...
public class ProfileRecyclerViewAdapter extends RecyclerView.Adapter<ProfileRecyclerViewAdapter.ViewHolder> {
    ...
    public ProfileRecyclerViewAdapter(Context context, List<Profiles> items) {
        itemsList = items;
        mContext = context;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_profile, parent, false);
...
//                .into(holder.image);
        ...
        holder.number.setText(""+itemsList.get(position).getSerial());
