...
public class ProblemandSolutionRecyclerViewAdapter extends RecyclerView.Adapter<ProblemandSolutionRecyclerViewAdapter.ViewHolder> {

    private static final String TAG = "RecyclerViewAdapter";

    //vars
    private List<ProblemSolution> itemsList = new ArrayList<>();

    private Context mContext;

    public ProblemandSolutionRecyclerViewAdapter(Context context, List<ProblemSolution> items) {
        itemsList = items;
        mContext = context;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_problemandsolution, parent, false);
