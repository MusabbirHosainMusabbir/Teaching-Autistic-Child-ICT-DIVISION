...
public class SubTopicListRepository {

    JSONObject reqJsonObj;
    public SubTopicListRepository(Application application, JSONObject reqJsonObj) {
    ...
    public LiveData<ArrayList<HashMap<String,String>>> getAllList(){
        ...
        Call<ResponseBody> call = RetrofitInstance.getInstance().getApi().doListSubActivity(requestBody);
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    JSONObject dailyactivityobj = jsonObject.getJSONObject("daily_sub_activity");
                    Log.e("repsonselength", String.valueOf(dailyactivityobj.length()));

                    for(int i=1; i<=dailyactivityobj.length(); i++){

                         Log.e("sda", String.valueOf(dailyactivityobj.getJSONObject(String.valueOf(i))));
                        ...
                        responseMap.put("subtopic_id",jObjectTopic.getString("subtopic_id"));
                        ...
                        responseMap.put("subtopic_image",jObjectTopic.getString("sub_topic_image"));

                        Log.e("subtname", jObjectTopic.getString("sub_topic_name"));
