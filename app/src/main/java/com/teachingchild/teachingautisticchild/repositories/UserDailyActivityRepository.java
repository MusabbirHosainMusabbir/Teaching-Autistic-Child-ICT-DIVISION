...
public class UserDailyActivityRepository {
    ...
    public UserDailyActivityRepository(Application application, JSONObject reqJsonObj) {
    ...
    public LiveData<HashMap<String,String>> getSubmitStatus(){
        ...
        Call<ResponseBody> call = RetrofitInstance.getInstance().getApi().doUserActivity(requestBody);
