...
public class ResendRepository {
    ...
    public ResendRepository(Application application, JSONObject reqJsonObj) {
    ...
    public LiveData<HashMap<String,String>> getOTPStatus(){
        ...
        Call<ResponseBody> call = RetrofitInstance.getInstance().getApi().doResend(requestBody);
